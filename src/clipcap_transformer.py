...
# source: https://github.com/rmokady/CLIP_prefix_caption/blob/main/train.py
...
class ClipCapTransformerMapper(nn.Module):
    def forward(self, x):
    ...
    def __init__(
        ...
        super(ClipCapTransformerMapper, self).__init__()
